  ...
  return (
    <div className={`card bordered max-w-xs compact rounded-md`}>
      ...
      <div className="sm:flex justify-center">
        ...
        <a target="_blank" className="btn text-xs bg-[#9945FF] hover:bg-[#7a37cc] uppercase sm:w-[50%] sm:ml-1 mb-2 sm:mb-4" href={"https://solscan.io/token/" + mint + '?cluster=devnet'}>Check Token</a>
      </div>
    </div>
  );
};
